      ...
      <div className="min-h-[80vh] flex items-center justify-center bg-slate-50 px-4">
        ...
        >
          ...
          <p className="text-slate-600 mb-8">
            This area is restricted to authorized managers. Please sign in with an admin account.
          </p>
          ...
          {!isEmailLogin ? (
            <div className="space-y-4">
              <button 
                ...
                className="w-full bg-brand-primary text-white px-8 py-4 rounded-full font-bold hover:bg-teal-800 transition-all flex items-center justify-center gap-3 shadow-lg shadow-teal-100 disabled:opacity-50"
              >
                {!isLoggingIn ? (
                  <>
